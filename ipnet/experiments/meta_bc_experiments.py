...
def train_meta_bc_agents_from_hh_data(layout_name, agent_name, num_epochs, lr, adam_eps, model):
    ...
    return train_meta_bc_agents(model_save_dir, bc_params, num_epochs=num_epochs, lr=lr, adam_eps=adam_eps)
...
def train_bc_models(all_params, seeds):
    ...
    for params in all_params:
        for seed_idx, seed in enumerate(seeds):
            ...
            model_dict = train_meta_bc_agents_from_hh_data(agent_name="bc_train_seed{}".format(seed_idx),
                                                           model='train', **params)
